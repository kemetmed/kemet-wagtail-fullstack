...
// js file paths
var utilJsPath = 'frontend/js/**/*.js'; // util.js path - you may need to update this if including the framework as external node module
var componentsJsPath = 'frontend/js/components/**/*.js'; // component js files
...
var scssFilesPath = 'frontend/sass/**/*.scss'; // scss files to watch
...
gulp.task('watch', gulp.series(['browserSync', 'sass', 'scripts'], function () {
  ...
  gulp.watch([utilJsPath, componentsJsPath], gulp.series(['scripts', reload]));
}));
...
function moveAssets() {
  return new Promise(function (resolve, reject) {
    var stream = gulp.src(['main/assets/img/**'], {
        allowEmpty: true
      })
